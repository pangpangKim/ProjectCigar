...
<body>
	<form action="/cigar/modify_ok.do" method="post" enctype="multipart/form-data">
		...
		사진이름 <input type="text" name="cigar_file_name" value="<%=cigar_file_name %>" readonly="readonly" /> <br/>
		사진크기 <input type="text" name="cigar_file_size" value="<%=cigar_file_size %>" readonly="readonly"/> <br/>
